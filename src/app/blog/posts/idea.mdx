...
preview:
  [
    "Developed and published Chrome extension for AI-powered product review analysis",
    "Implemented sophisticated NLP pipeline using GPT for review interpretation",
  ]
---
